...
;; - subsidies
;; - tax
;; - support-for-sustainable-behavior
...
to setup-organisations
  ...
  [
    ...
    set instrumental-motivation brand * 100
...
to setup-additional-variables
  set external-competition-list [["low" 0.8] ["medium" 1.0] ["high" 1.2]]
